...
/** Matches `public/Logo.svg` — keep paths in sync when the brand asset updates */
const FILL = "#231f20";
const VIEW_W = 533.68;
const VIEW_H = 98.06;

type Props = {
  /** Display width; height follows SVG aspect ratio (~5.44:1) */
  width: number;
  className?: string;
};

export function BathraLogoMark({ width, className = "" }: Props) {
